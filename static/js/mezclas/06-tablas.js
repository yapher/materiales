...
IAM.renderTablaPrediccion = function () {
    ...
    if (IAM.state.datosPrediccion.length === 0) {
        ...
        // Ocultar panel de densidad inline si no hay predicción
        IAM.actualizarVisibilidadGraficoDensidad();
        IAM.notificarWorkflow();
        return;
    }
    ...
    // Mostrar panel de densidad inline SOLO cuando hay predicción
    IAM.actualizarVisibilidadGraficoDensidad();
    IAM.notificarWorkflow();
};
